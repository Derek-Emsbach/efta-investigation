...
thread_id: "02"
thread_name: "The Dubin Architecture"
version: "1.0"
date: "2026-02-26"
...
primary_entities:
  - name: "Glenn Dubin"
    uuid: "c8b4057b-xxxx-xxxx-xxxx-xxxxxxxxxxxx"
    tier: 1
...
This inconsistent redaction is notable. If the name was redacted in the original for privacy reasons, it should logically have been redacted in the A&R as well. The inconsistency may reflect:
...
### OQ-T02-01 [P1]: Why was Celina Edith Dubin the primary beneficiary?

The central question of this thread. Epstein had no publicly known familial relationship with Celina. The trust directs essentially his entire estate to her. Possible explanations include:

<!-- SENSITIVITY: SPECULATION_ABOUT_REDACTED_IDENTITIES -->

[SPECULATION_START]
Several hypotheses could explain the Celina bequest, listed from most to least charitable:

1. **Genuine affection**: Epstein had a documented long-term friendship with the Dubin family. The bequest to Celina may reflect a quasi-parental relationship.
2. **Financial arrangement with Glenn**: The bequest may represent a return on investment, compensation for services, or the completion of a financial arrangement between Epstein and Glenn Dubin.
3. **Insurance mechanism**: Directing the estate to Glenn's daughter created mutual dependency — the Dubins would not challenge or undermine the estate that enriched their family, and Epstein secured the loyalty of a prominent family.
4. **Leverage architecture**: The most concerning hypothesis: directing wealth to Glenn Dubin's minor daughter while holding evidence of Glenn's sexual conduct with a trafficked victim creates a structural leverage position. The estate's value to the Dubins depended on its remaining unchallenged; the estate's unchallenged status depended on Glenn's conduct remaining unexamined.

None of these hypotheses can be confirmed or excluded from the trust documents alone. The trust reveals *what* Epstein did — directed his wealth to the Dubins — but not *why*.
[SPECULATION_END]

<!-- /SENSITIVITY -->

### OQ-T02-02 [P1]: Did SDNY examine the trust-beneficiary connection to the prosecution memo evidence?

The prosecution memo documents Glenn Dubin on page 57. The trust documents direct $250M+ to his family. Were these ever analyzed together? The redacted charging analysis (pages 74-85) may contain this assessment, but its absence from the unredacted factual sections suggests it was not a focus.

### OQ-T02-03 [P2]: Has Eva Andersson-Dubin ever served as trustee?

Eva was the first successor trustee in all three versions. After Epstein's death and the departure of Staley (from Barclays, though not necessarily from the trust), did Eva assume trustee duties? Has any trustee resigned, triggering her succession? No resignation documents have been found in the EFTA corpus.

### OQ-T02-04 [P2]: What is the current status of the property trusts?

The NYC townhouse was reportedly sold. Little St. James was listed for sale. What happened to the Celina Dubin trusts that held these properties? Were the property trusts dissolved? Did Celina (or a guardian) consent to the sales? How were the proceeds distributed?

### OQ-T02-05 [P2]: What was in the missing Schedule A?

The trust references "the property described in Schedule A annexed hereto" but no version of the trust produced in the EFTA releases includes Schedule A. This schedule would identify every asset placed into the trust — potentially revealing the full scope of what Celina Dubin inherited. Was Schedule A deliberately excluded from the production?

### OQ-T02-06 [P3]: What is the relationship between the Dubin bequest and the Wexner-origin wealth?

The prosecution memo establishes that Epstein's wealth was "virtually all" derived from money stolen from Leslie Wexner (EFTA02731082, pp. 64-65). The $100M settlement in January 2008 returned some of this. The estate Celina Dubin was set to inherit was substantially derived from this misappropriation. Was this ever raised in the context of the USVI civil litigation or the trust administration?
...
|-------------|-------|------|---------------------|
| EFTA01266380 | The Jeffrey E. Epstein 2014 Trust | November 18, 2014 | Original trust — Celina as primary beneficiary (redacted), Eva as successor trustee, property bequests |
| EFTA01266403 | Amendment and Restatement of the Jeffrey E. Epstein 2014 Trust | May 1, 2015 | Celina named explicitly, MIT added, property operating funds formalized, full beneficiary structure visible |
| EFTA01266427 | First Amendment to the A&R | ~September 2015 | No changes to Dubin beneficiary structure; employment cliff and conditional bequests added (see THREAD_03) |
| EFTA02731082 | SDNY Co-Conspirator Prosecution Memo | December 19, 2019 | Glenn Dubin named — Maxwell directed victim to sexual contact (p. 57); Eva present during directed massage (p. 57) |
