    ...
    <footer className="border-t border-border-default bg-text-primary text-surface">
      <div className="mx-auto max-w-7xl px-6 py-12">
        ...
        <div className="mt-10 border-t border-border-default pt-6 text-center text-xs text-text-muted">
          <p>
            &copy; 2025&ndash;2026 The Epstein Crimes. All documents are publicly released government records.
            Research assisted by Claude AI (Anthropic). Edited by Derek Emsbach. Built by Cyclops Digital LLC.
          </p>
          <p className="mt-1">
