            ...
            <div className="flex items-center gap-3 mt-1.5 flex-wrap">
              ...
              {owner && (
                <span className="text-sm text-text-muted">
                  Owned by{' '}
                  <Link href={`/entities/${owner.id}`} className="text-info hover:text-info/80 transition-colors">
                    {owner.name}
                  </Link>
                </span>
              )}
            ...
            <dl className="space-y-4">
              ...
              {owner && (
                <div>
                  ...
                  <dd className="mt-0.5">
                    <Link href={`/entities/${owner.id}`} className="text-sm text-info hover:text-info/80 transition-colors">
                      {owner.name}
                    </Link>
